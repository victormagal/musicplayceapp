...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@jhonatasmartins/musicplayce";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "exp2ad727479f3a40c1939b4942aae703e7";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@jhonatasmartins/musicplayce/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40jhonatasmartins%2Fmusicplayce%2F1.0.0%2Fe45edd81c0127ca8a913e483560c8e91-27.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
