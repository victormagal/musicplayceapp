...
export const API_LANGUAGES = `${API}/api/languages`;
export const API_SONG_ARTIST = `${API}/api/song-artist`;
export const API_STATES = `${API}/api/states`;
export const API_INVITE = `${API}/api/invite`;
