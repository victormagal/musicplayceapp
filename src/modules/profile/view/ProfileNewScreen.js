...
class ProfileNewScreenContainer extends React.Component {
    constructor(props){
        super(props);
...
const ProfileNewScreen = connect(mapStateToProps)(ProfileNewScreenContainer);
export {ProfileNewScreen};
