        ...
        <ScrollView>
          <View>
            ...
            <View style={ styles.partnershipContainer}>
              <MPSongRating songName={'Tocando em Frente'} imagePath={images.daftPunk100} onPress={() => {}}
                            isNew={true}/>
              <MPPlusIcon style={ styles.partnershipIcon }/>
              <MPArtist artist={'Bruno Caliman'} imagePath={images.bjork100} onPress={() => {}}/>
            </View>
            <MPText style={ styles.infoText }><MPText style={ styles.infoTextEmph }>203</MPText>
              outras pessoas sugeriram esta parceria também!</MPText>
