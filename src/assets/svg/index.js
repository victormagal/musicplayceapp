...
export const MPAddGrayIcon = (props) => { 
 let newProps = applyStyle(props, 16, 16); 
 return (<Svg {...newProps} viewBox='0 0 16 16'><Path d='M2 2l12 12m0-12L2 14' fill='none' stroke='#959595' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'/></Svg>); 
};

export const MPAddMusicRedIcon = (props) => { 
 let newProps = applyStyle(props, 24, 24); 
 return (<Svg {...newProps} viewBox='0 0 24 24'><Path d='M17.988 9.462v1.758h-1.758v1.269h1.758v1.759h1.269v-1.759h1.758v-1.269h-1.758v-1.758h-1.269zM18.768 17.076c-2.803 0-5.076-2.273-5.076-5.076s2.273-5.076 5.076-5.076 5.076 2.273 5.076 5.076-2.273 5.076-5.076 5.076zM11.999 15.22c0.029 0.574-0.607 1.187-1.568 1.452-1.104 0.304-2.22 0.035-2.491-0.602s0.404-1.401 1.509-1.705c0.663-0.183 1.33-0.159 1.816 0.028l0-6.506-6.965 0.66-0.027 7.775c0.004 0.045 0.004 0.090-0.001 0.135v0.001c-0.052 0.54-0.666 1.092-1.565 1.34-1.104 0.304-2.22 0.035-2.491-0.602s0.404-1.4 1.509-1.705c0.657-0.181 1.318-0.159 1.803 0.023v-8.585l8.472-0.849-0.001 9.142z' fill='#DF342C'/></Svg>); 
};

export const MPAddMusicIcon = (props) => { 
 let newProps = applyStyle(props, 24, 24); 
 return (<Svg {...newProps} viewBox='0 0 24 24'><Path d='M17.988 9.462v1.758h-1.758v1.269h1.758v1.759h1.269v-1.759h1.758v-1.269h-1.758v-1.758h-1.269zM18.768 17.076c-2.803 0-5.076-2.273-5.076-5.076s2.273-5.076 5.076-5.076 5.076 2.273 5.076 5.076-2.273 5.076-5.076 5.076zM11.999 15.22c0.029 0.574-0.607 1.187-1.568 1.452-1.104 0.304-2.22 0.035-2.491-0.602s0.404-1.401 1.509-1.705c0.663-0.183 1.33-0.159 1.816 0.028l0-6.506-6.965 0.66-0.027 7.775c0.004 0.045 0.004 0.090-0.001 0.135v0.001c-0.052 0.54-0.666 1.092-1.565 1.34-1.104 0.304-2.22 0.035-2.491-0.602s0.404-1.4 1.509-1.705c0.657-0.181 1.318-0.159 1.803 0.023v-8.585l8.472-0.849-0.001 9.142z' fill='#fff'/></Svg>); 
};
...
export const MPBonusIcon = (props) => { 
 let newProps = applyStyle(props, 44, 44); 
 return (<Svg {...newProps} viewBox='0 0 44 44'><Path d='M0 29.097l4.258 4.258 0.355-0.355c1.768-1.768 4.619-1.768 6.387 0s1.768 4.619 0 6.387l-0.355 0.355 4.258 4.258 29.097-29.097-4.258-4.258-0.355 0.355c-1.768 1.768-4.619 1.768-6.387 0s-1.768-4.619 0-6.387l0.355-0.355-4.258-4.258-29.097 29.097z' fill='#fff'/><Path d='M1.414 29.097l2.859 2.859c2.17-1.815 5.394-1.703 7.433 0.337s2.152 5.264 0.337 7.433l2.859 2.859 27.683-27.683-2.859-2.859c-2.17 1.815-5.394 1.703-7.433-0.337s-2.152-5.263-0.337-7.433l-2.859-2.859-27.683 27.683z' fill='none' stroke='#e13223' strokeWidth='2' strokeMiterlimit={4} strokeLinecap='butt' strokeLinejoin='miter'/><Path d='M20 11l12.9 12.9' fill='none' stroke='#e13223' strokeWidth='2' strokeMiterlimit={4} strokeLinecap='butt' strokeLinejoin='miter'/></Svg>); 
};

export const MPCameraIcon = (props) => { 
 let newProps = applyStyle(props, 28, 22); 
 return (<Svg {...newProps} viewBox='0 0 28 22'><Path d='M10.609.5L9.212 3.36a.83.83 0 0 1-.747.473H1.953c-.809 0-1.453.66-1.453 1.5V20c0 .84.644 1.5 1.453 1.5h24.094c.809 0 1.453-.66 1.453-1.5V5.333c0-.84-.644-1.5-1.453-1.5h-6.509a.83.83 0 0 1-.747-.468L17.39.5H10.61zm8.929 2.333h-.003.003zm-11.072 0h.003a.22.22 0 0 0-.003 0zm-.153.09a.165.165 0 0 0-.002.003l.002-.003zM14 6.5c3.034 0 5.5 2.466 5.5 5.5s-2.466 5.5-5.5 5.5A5.504 5.504 0 0 1 8.5 12c0-3.034 2.466-5.5 5.5-5.5z' fill='none' stroke='#FFF'/></Svg>); 
};
...
export const MPConnectionIcon = (props) => { 
 let newProps = applyStyle(props, 32, 32); 
 return (<Svg {...newProps} viewBox='0 0 32 32'><Path d='M24 15.713c0 2.946-1.78 5.675-4.535 6.953l-0.495-0.993c2.362-1.096 3.888-3.435 3.888-5.96 0-3.645-3.076-6.611-6.857-6.611s-6.857 2.965-6.857 6.611c0 2.526 1.527 4.865 3.89 5.961l-0.496 0.993c-2.755-1.278-4.537-4.007-4.537-6.954 0-4.253 3.589-7.713 8-7.713s8 3.46 8 7.713zM16 2.667c7.352 0 13.333 5.977 13.333 13.324 0 5.145-2.878 9.739-7.511 11.99l-0.486-0.999c4.247-2.063 6.886-6.274 6.886-10.991 0-6.735-5.483-12.213-12.222-12.213s-12.222 5.479-12.222 12.213c0 4.662 2.718 8.985 6.923 11.010l-0.482 1c-4.588-2.209-7.552-6.923-7.552-12.010 0-7.346 5.982-13.324 13.333-13.324zM16 14.667c0.736 0 1.333 0.73 1.333 1.63 0 0.709-0.372 1.305-0.889 1.53v11.507h-0.889v-11.507c-0.517-0.225-0.889-0.821-0.889-1.53 0-0.899 0.597-1.63 1.333-1.63z' fill='#E55C54'/></Svg>); 
};
...
export const MPPlayerHeartIcon = (props) => { 
 let newProps = applyStyle(props, 22, 20); 
 return (<Svg {...newProps} viewBox='0 0 22 20'><Path d='M15.544 0c-1.647 0-3.325 0.66-4.552 2.014-1.26-1.354-2.905-2.014-4.552-2.014s-3.293 0.66-4.552 2.014c-2.517 2.708-2.517 7.118 0 9.826l9.104 8.16 9.136-8.16c1.259-1.354 1.872-3.125 1.872-4.896s-0.613-3.541-1.872-4.895c-1.26-1.39-2.906-2.049-4.584-2.049z' fill='#fff' fillOpacity='0.209584584'/><Path d='M10.993 19.33l8.768-7.83c1.132-1.217 1.739-2.845 1.739-4.556s-0.607-3.338-1.743-4.56c-1.121-1.237-2.61-1.884-4.213-1.884-0.004 0-0.008-0-0.013-0-1.651 0-3.136 0.712-4.165 1.845l-0.004 0.005-0.365 0.403-0.371-0.399c-1.126-1.21-2.62-1.854-4.186-1.854s-3.060 0.645-4.185 1.854c-2.34 2.517-2.34 6.63-0.033 9.114l8.77 7.861z' fill='none' stroke='#e13223' strokeWidth='1' strokeMiterlimit={4} strokeLinecap='butt' strokeLinejoin='miter'/></Svg>); 
};

export const MPPlayerNextRedIcon = (props) => { 
 let newProps = applyStyle(props, 18, 20); 
 return (<Svg {...newProps} viewBox='0 0 18 20'><Path d='M16.5 0c-0.828 0-1.5 0.672-1.5 1.5v17c0 0.828 0.672 1.5 1.5 1.5s1.5-0.672 1.5-1.5v-17c0-0.828-0.672-1.5-1.5-1.5z' fill='#e13223'/><Path d='M1.257 0c-0.694 0-1.257 0.587-1.257 1.31l0.005 17.384c0 0.235 0.060 0.472 0.186 0.686 0.364 0.614 1.135 0.804 1.724 0.425l13.474-8.681c0.175-0.111 0.318-0.257 0.421-0.43l0.003-0.006c0.363-0.613 0.181-1.417-0.408-1.796l-13.395-8.632c-0.21-0.163-0.47-0.26-0.752-0.26z' fill='#e13223'/></Svg>); 
};

export const MPPlayerPauseRedIcon = (props) => { 
 let newProps = applyStyle(props, 18, 30); 
 return (<Svg {...newProps} viewBox='0 0 18 30'><Path d='M3 0c1.657 0 3 1.343 3 3v24c0 1.657-1.343 3-3 3s-3-1.343-3-3v-24c0-1.657 1.343-3 3-3z' fill='#e13223'/><Path d='M15 0c1.657 0 3 1.343 3 3v24c0 1.657-1.343 3-3 3s-3-1.343-3-3v-24c0-1.657 1.343-3 3-3z' fill='#e13223'/></Svg>); 
};

export const MPPlayerPlayRedIcon = (props) => { 
 let newProps = applyStyle(props, 24, 30); 
 return (<Svg {...newProps} viewBox='0 0 24 30'><Path d='M1.885 0C.845 0 0 .88 0 1.965l.007 26.077c0 .351.09.707.28 1.029.545.92 1.703 1.205 2.585.637l20.211-13.023a1.91 1.91 0 0 0 .637-.652c.544-.92.271-2.127-.612-2.696L3.014.39A1.83 1.83 0 0 0 1.885 0z' fill='#E13223'/></Svg>); 
};

export const MPPlayerPreviousRedIcon = (props) => { 
 let newProps = applyStyle(props, 18, 20); 
 return (<Svg {...newProps} viewBox='0 0 18 20'><Rect  fill='#E13223' width='3' height='20' rx='1.5'/><Path fill='#E13223' d='M16.743 0C17.437 0 18 .587 18 1.31l-.005 17.384c0 .235-.06.472-.186.686-.364.614-1.135.804-1.724.425L2.611 11.124a1.274 1.274 0 0 1-.424-.436c-.363-.613-.181-1.417.408-1.796L15.99.26c.21-.163.47-.26.752-.26z'/></Svg>); 
};

export const MPPlusArtistAvatarRedIcon = (props) => { 
 let newProps = applyStyle(props, 12, 13); 
 return (<Svg {...newProps} viewBox='0 0 12 13'><Path d='M11.1 11.3c-1.4 1-3.2 1.5-5.1 1.5-0.1 0-0.1 0-0.2 0-1.8 0-3.5-0.4-4.9-1.3-0.2-0.1-0.3-0.2-0.3-0.4 0 0 0 0 0 0v-0.5c0.1-1.5 1.2-3.2 5.2-3.2h0.1c4.1 0 5.2 1.6 5.4 3 0 0 0 0.1 0 0.1s0 0 0 0v0.4c0.1 0.2 0 0.3-0.2 0.4zM10.4 10.5c0 0 0 0 0 0v0c0 0 0 0 0 0-0.3-1.9-2.5-2.2-4.4-2.2h-0.2c-1.8 0-4.1 0.5-4.3 2.3v0.2c1.3 0.7 2.7 1.1 4.4 1.1 1.6 0 3.1-0.4 4.4-1.2l0.1-0.2zM5.9 6c0 0 0 0 0 0-0.8 0-1.5-0.3-2-0.9s-0.8-1.4-0.8-2.2c0-1.6 1.1-2.8 2.7-2.8 0 0 0 0 0.1 0 1.6 0 2.7 1.1 2.7 2.7 0 0.8-0.3 1.6-0.7 2.2-0.6 0.6-1.2 1-2 1zM7.1 1.5c-0.3-0.3-0.7-0.4-1.3-0.4v0c-1.1 0-1.8 0.7-1.7 1.8 0 0.6 0.2 1.1 0.6 1.5 0.3 0.4 0.8 0.7 1.2 0.6 0.5 0 0.9-0.2 1.2-0.6s0.5-1 0.5-1.6c0-0.5-0.1-0.9-0.5-1.3z' fill='#F3B6B2'/></Svg>); 
};
...
export const MPPlusPhotoIcon = (props) => { 
 let newProps = applyStyle(props, 27, 27); 
 return (<Svg {...newProps} viewBox='0 0 27 27'><Path d='M13.5 27c7.456 0 13.5-6.044 13.5-13.5s-6.044-13.5-13.5-13.5-13.5 6.044-13.5 13.5 6.044 13.5 13.5 13.5z' fill='#fff'/><Path d='M10.035 13.5h6.931M13.5 10.035v6.931' fill='#000' stroke='#5994db' strokeWidth='1.1571' strokeMiterlimit={4} strokeLinecap='round' strokeLinejoin='round'/></Svg>); 
};
...
export const MPSettingsIcon = (props) => { 
 let newProps = applyStyle(props, 20, 20); 
 return (<Svg {...newProps} viewBox='0 0 20 20'><Path d='M3.341 5.334l-.09-.15c-.567-.946-.342-2.287.504-2.997l-.506.425c.846-.71 2.209-.698 3.039.023l.096.083a8.066 8.066 0 0 1 1.61-.602l.023-.145C8.19.882 9.224 0 10.329 0h-.66c1.103 0 2.14.886 2.312 1.97l.022.143a8.065 8.065 0 0 1 1.616.6l.091-.079c.832-.722 2.192-.733 3.039-.023l-.507-.425c.846.71 1.07 2.055.505 2.997l-.084.14c.34.477.63.991.867 1.536l.14-.002c1.101-.019 2.15.847 2.342 1.935l-.115-.651c.192 1.087-.5 2.261-1.54 2.62l-.145.05a8.51 8.51 0 0 1-.302 1.76l.122.098c.856.694 1.103 2.032.55 2.989l.33-.573c-.551.956-1.836 1.41-2.862 1.018l-.114-.044c-.4.424-.843.805-1.322 1.136l.03.155c.21 1.082-.461 2.265-1.5 2.643l.622-.226c-1.038.378-2.314-.1-2.847-1.061l-.065-.116a8.162 8.162 0 0 1-1.71-.001l-.065.116c-.535.963-1.809 1.439-2.847 1.06l.621.227c-1.038-.378-1.708-1.565-1.499-2.643l.031-.162a8.31 8.31 0 0 1-1.313-1.131l-.128.049c-1.03.394-2.31-.06-2.863-1.018l.33.573c-.552-.956-.303-2.296.55-2.988l.137-.11a8.51 8.51 0 0 1-.298-1.747l-.157-.054C.601 10.401-.088 9.23.103 8.141l-.114.652c.192-1.088 1.244-1.954 2.343-1.936l.149.003a8.418 8.418 0 0 1 .86-1.526zM10 14.907c2.523 0 4.569-2.085 4.569-4.658 0-2.573-2.046-4.659-4.57-4.659-2.523 0-4.568 2.086-4.568 4.659s2.045 4.658 4.569 4.658z' fill='#FFF'/></Svg>); 
};
...
export const MPSongAddIcon = (props) => { 
 let newProps = applyStyle(props, 34, 28); 
 return (<Svg {...newProps} viewBox='0 0 34 28'><Path d='M14 0.5c-7.456 0-13.5 6.044-13.5 13.5s6.044 13.5 13.5 13.5 13.5-6.044 13.5-13.5-6.044-13.5-13.5-13.5z' fill='none' stroke='#fff' strokeWidth='1' strokeMiterlimit={4} strokeLinecap='butt' strokeLinejoin='miter'/><Path d='M19.998 17.806c0.035 0.678-0.717 1.402-1.853 1.716-1.305 0.36-2.623 0.041-2.944-0.712s0.478-1.656 1.783-2.016c0.784-0.216 1.572-0.188 2.147 0.033v-7.69l-8.233 0.78-0.032 9.19c0.002 0.024 0.004 0.052 0.004 0.080s-0.001 0.056-0.004 0.084l0-0.004c-0.062 0.64-0.788 1.292-1.85 1.585-1.306 0.36-2.625 0.041-2.945-0.712s0.478-1.656 1.783-2.016c0.777-0.214 1.558-0.188 2.131 0.027v-10.148l10.015-1.003-0.002 10.806zM28 20c3.314 0 6-2.686 6-6s-2.686-6-6-6v0c-3.314 0-6 2.686-6 6s2.686 6 6 6v0z' fill='#fff'/><Path d='M25.17 14h5.657M27.998 11.172v5.656' fill='#000' stroke='#b91a1c' strokeWidth='2' strokeMiterlimit={4} strokeLinecap='round' strokeLinejoin='round'/></Svg>); 
};
...
export const MPSongRedIcon = (props) => { 
...
export const MPSongUploadEditIcon = (props) => { 
 let newProps = applyStyle(props, 34, 34); 
 return (<Svg {...newProps} viewBox='0 0 34 34'><Path d='M17 0.607c-9.054 0-16.393 7.339-16.393 16.393s7.339 16.393 16.393 16.393 16.393-7.339 16.393-16.393-7.339-16.393-16.393-16.393z' fill='none' stroke='#fff' strokeWidth='1.2143' strokeMiterlimit={4} strokeLinecap='butt' strokeLinejoin='miter'/><Path d='M25.092 19.090l-9.797 5.79c-0.354 0.212-0.78 0.338-1.236 0.338-1.341 0-2.429-1.087-2.429-2.429 0-0 0-0 0-0.001v-11.577c0-0.001 0-0.002 0-0.002 0-1.341 1.087-2.429 2.429-2.429 0.456 0 0.884 0.126 1.248 0.345l-0.011-0.006 9.797 5.79c0.719 0.431 1.192 1.205 1.192 2.090s-0.474 1.66-1.181 2.084l-0.011 0.006z' fill='#000'/><Path d='M25.092 19.090l-9.797 5.79c-0.354 0.212-0.78 0.338-1.236 0.338-1.341 0-2.429-1.087-2.429-2.429 0-0 0-0 0-0.001v-11.577c0-0.001 0-0.002 0-0.002 0-1.341 1.087-2.429 2.429-2.429 0.456 0 0.884 0.126 1.248 0.345l-0.011-0.006 9.797 5.79c0.719 0.431 1.192 1.205 1.192 2.090s-0.474 1.66-1.181 2.084l-0.011 0.006z' fill='#fff'/></Svg>); 
};
...
export const MPTriangleUpBlackIcon = (props) => { 
 let newProps = applyStyle(props, 8, 6); 
 return (<Svg {...newProps} viewBox='0 0 8 6'><Path d='M7.476 6L.522 5.998a.564.564 0 0 1-.274-.07c-.245-.136-.322-.425-.17-.646L3.551.229A.496.496 0 0 1 3.725.07c.245-.136.567-.068.718.153l3.453 5.024A.44.44 0 0 1 8 5.529c0 .26-.235.471-.524.471z' fill='#000'/></Svg>); 
};

export const MPTriangleUpGrayIcon = (props) => { 
 let newProps = applyStyle(props, 8, 6); 
 return (<Svg {...newProps} viewBox='0 0 8 6'><Path d='M7.476 6L.522 5.998a.564.564 0 0 1-.274-.07c-.245-.136-.322-.425-.17-.646L3.551.229A.496.496 0 0 1 3.725.07c.245-.136.567-.068.718.153l3.453 5.024A.44.44 0 0 1 8 5.529c0 .26-.235.471-.524.471z' fill='#A8A8A8'/></Svg>); 
};

export const MPTriangleUpIcon = (props) => { 
 let newProps = applyStyle(props, 10, 8); 
 return (<Svg {...newProps} viewBox='0 0 10 8'><Path d='M10 7.372A.642.642 0 0 1 9.345 8L.653 7.998a.67.67 0 0 1-.343-.094.612.612 0 0 1-.213-.861L4.438.306A.67.67 0 0 1 5.554.298L9.87 6.994a.61.61 0 0 1 .13.377z' fill='#fff'/></Svg>); 
};
